...
pub(crate) use text_document::{
    ...
    InlayHintDocumentRevision, InlayHintEnvelope, KakehashiEnvelope, UpstreamCodeActionCaps,
    bridge_code_actions, bridge_host_completion_items, envelope_host_call_hierarchy_items,
