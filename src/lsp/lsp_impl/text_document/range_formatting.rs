...
impl Kakehashi {
    pub(crate) async fn range_formatting_impl(
        ...
        // A settings reload's placeholder is waited past too; one still
        // standing at the deadline falls through with never-parsed/gone to
        // the layers' empty fallbacks.
