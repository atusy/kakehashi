...
- Moniker / Inlay Hint (incl. `inlayHint/resolve` routed back to the exact producing host or injection server; lazy text edits and label locations are translated, while stale injection hints fail soft)
