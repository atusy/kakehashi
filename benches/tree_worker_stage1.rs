    ...
    println!(
        ...
        serde_json::to_string_pretty(&json!({
            ...
            "parallel": {
                ...
                "direct_parser_cache_hits": direct_cache_hits.into_iter().filter(|hit| *hit == Some(true)).count(),
                "worker_parser_cache_hits": worker_cache_hits.into_iter().filter(|hit| *hit == Some(true)).count(),
